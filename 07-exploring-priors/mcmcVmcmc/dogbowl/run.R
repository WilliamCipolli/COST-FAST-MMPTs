...
colnames(data.for.plotting)[-c(1,2)]<-c("Average of Two Square Roots","Symmetric Square Root",
                                        "Rotated Square Root", "MCMC Sampler 2", "MCMC Sampler 1")
...
#Compare Sampling
################################################################
df.fast <- tibble(Iterate = 1:1000000,
                  mu1 = pt.new$muvals1[12001:1012000],
                  mu2 = pt.new$muvals2[12001:1012000],
                  sigma11 = pt.new$sigmavals11[12001:1012000],
                  sigma12 = pt.new$sigmavals12[12001:1012000],
                  sigma21 = pt.new$sigmavals21[12001:1012000],
                  sigma22 = pt.new$sigmavals22[12001:1012000],
                  cp = pt.new$cpvalues[12001:1012000],
                  O11 = pt.new$Ovals11[12001:1012000],
                  O12 = pt.new$Ovals12[12001:1012000],
                  O21 = pt.new$Ovals21[12001:1012000],
                  O22 = pt.new$Ovals22[12001:1012000])

df.mcmc <- tibble(Iterate = 1:1000000,
                  mu1 = pt.new2$muvals1[12001:1012000],
                  mu2 = pt.new2$muvals2[12001:1012000],
                  sigma11 = pt.new2$sigmavals11[12001:1012000],
                  sigma12 = pt.new2$sigmavals12[12001:1012000],
                  sigma21 = pt.new2$sigmavals21[12001:1012000],
                  sigma22 = pt.new2$sigmavals22[12001:1012000],
                  cp = pt.new2$cpvalues[12001:1012000],
                  O11 = pt.new2$Ovals11[12001:1012000],
                  O12 = pt.new2$Ovals12[12001:1012000],
                  O21 = pt.new2$Ovals21[12001:1012000],
                  O22 = pt.new2$Ovals22[12001:1012000])
library(patchwork)
...
mu1 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=mu1, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=mu1, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  ...
  scale_x_continuous(breaks=seq(0,1000000, length.out=5),
                     labels = c("0", "250k", "500k", "750k", "1M"))

mu2 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=mu2, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=mu2, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
mu3 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=mu1, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=mu1, color="MCMC 2"), geom = "line")+
...
mu4 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=mu2, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=mu2, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  xlab(bquote(mu[x[2]]))+
...
sigma11 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=sigma11, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=sigma11, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
sigma12 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=sigma12, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=sigma12, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
sigma21 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=sigma21, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=sigma21, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
sigma22 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=sigma22, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=sigma22, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
sigma11 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=sigma11, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=sigma11, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
...
sigma12 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=sigma12, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=sigma12, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
...
sigma21 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=sigma21, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=sigma21, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
...
sigma22 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=sigma22, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=sigma22, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
...
cp1 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=cp, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=cp, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
cp2 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=cp, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=cp, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  xlab(bquote(alpha))+
...
O11 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=O11, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=O11, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
O12 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=O12, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=O12, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
O21 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=O21, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=O21, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
O22 <- ggplot()+
  geom_point(data=df.mcmc, aes(x=Iterate, y=O22, color="MCMC 1", shape="MCMC 1"))+
  geom_point(data=df.fast, aes(x=Iterate, y=O22, color="MCMC 2", shape="MCMC 2"))+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  scale_shape_manual("Sampler", values=c(19,1))+
  xlab("MCMC Iterate")+
...
O11 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=O11, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=O11, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  xlab(bquote(O[1*","*1]))+
...
O12 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=O12, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=O12, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  xlab(bquote(O[1*","*2]))+
...
O21 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=O21, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=O21, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  xlab(bquote(O[2*","*1]))+
...
O22 <- ggplot() +
  stat_density(data=df.mcmc, aes(x=O22, color="MCMC 1"), geom = "line")+
  stat_density(data=df.fast, aes(x=O22, color="MCMC 2"), geom = "line")+
  geom_hline(yintercept = 0)+
  theme_bw()+
  scale_color_manual("Sampler", values=c("black","grey"))+
  xlab(bquote(O[2*","*2]))+
...
g +
  ...
  ylab("Density Difference (MCMC 1 - MCMC 2)")
dev.off()
...
p1 <- ggplot(data=ggdat1) +
  ...
  geom_hline(yintercept=0)+
  theme_bw()+
  xlab("Density Difference (MCMC 1 - MCMC 2)")+
  ylab("Density")
...
p2 <- ggplot(data=ggdat2) +
  ...
  theme_bw()+
  scale_x_continuous("Density Estimate (MCMC 2)",
  ...
  scale_y_continuous("Density Estimate (MCMC 1)",
                     limits = c(mindens, maxdens),
                     breaks = seq(mindens, maxdens, length.out=5),
                     labels = format(round(seq(mindens, maxdens, length.out=5),3), nsmall=3))
