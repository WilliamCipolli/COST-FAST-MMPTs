...
png("cptrace.png", width = 8, height = 2.5, units = "in", res = 400)
cp1 <- ggplot()+
...
cp2 <- ggplot() +
  ...
  scale_x_continuous(breaks = c(0, 5*10^(305), 1*10^(306), 1.5*10^(306), 2*10^(306)),
                     labels = c("0", "5.0e305","1.0e306", "1.5e306", "2.0e306"))+
  scale_y_continuous(breaks = c(0, 1*10^(-228), 2*10^(-228), 3*10^(-228), 4*10^(-228)),
                     labels = c("0", "1.0e-228","2.0e-228", "3.0e-228", "4.0e-228"))
